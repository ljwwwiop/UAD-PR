...
def get_args():
    parser = argparse.ArgumentParser(description="UAD Args")
    ######################## general settings ########################
    ...
    parser.add_argument("--text_length", type=int, default=77)  ########  clip-77, longclip-248
    ...
    parser.add_argument("--root_dir", default="/opt/data/private/datasets")
